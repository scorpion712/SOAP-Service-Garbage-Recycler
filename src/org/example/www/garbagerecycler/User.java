...
public class User implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * Namespace URI = http://www.example.org/GarbageRecycler/ Namespace Prefix =
	 * ns1
	 */

	@Override
	public boolean equals (Object otherUser) {
		return this.localUsername.equalsIgnoreCase(((User)otherUser).getUsername());
	}
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"User".equals(type)) {
							...
							return (User) org.example.www.garbagerecycler.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
